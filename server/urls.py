...
from project.views import ClientProjectView, UserProjectView
...
urlpatterns = [
    ...
    path("api/client/project", ClientProjectView.as_view(), name="project"),
    path("api/user/project", UserProjectView.as_view(), name="project"),
]
